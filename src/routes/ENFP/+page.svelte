<script>
  ...
  { 
    ...
    herowp : "background-image: url('./image/enfp-folder/wallpaper.png');",
    mbti : "ENFP",
    alias : "The Campaigner",
    desc : "ENFP adalah penyebar inspirasi yang energik dan imajinatif. Mereka mencari kemungkinan baru, hubungan tulus, serta cara paling hidup untuk menyalakan semangat kolektif dan membuka pintu perubahan yang optimis.",
    icon1 : "Extrovert",
    icon2 : "Intuition",
    icon3 : "Feeling",
    icon4 : "Perceiving",
    mbticon : "./image/mbti-illustration/ENFP.png"
  }
  const description = [
    {
      id : "intj",
      header : "ENFP",
      desc : "ENFP, kamu adalah pribadi yang penuh energi, hangat, dan sangat terbuka pada berbagai kemungkinan baru. Kamu cepat menangkap potensi dalam diri orang lain maupun dalam sebuah ide, dan kamu cenderung bergerak mengikuti antusiasme yang muncul dari hal-hal yang menurutmu bermakna. Kamu punya perpaduan unik antara kreativitas, empati, dan dorongan untuk menjelajah, sehingga kamu sering dianggap sebagai sosok yang hidup, inspiratif, dan membawa suasana positif ke mana pun kamu pergi.",
      position : "text-align: left;",
    },
    {
      id : "theanalyst",
      header : "The Campaigner",
      desc : "ENFP mendapat julukan ini karena kamu adalah tipe yang membakar semangat orang lain dan mendorong mereka keluar dari batasan lama. Kamu suka mengajak orang untuk melihat kemungkinan yang belum mereka sadari, dan kamu punya karisma natural yang membuat orang merasa diterima. Kamu tidak hanya punya banyak ide—kamu menyebarkan antusiasme itu sehingga orang-orang ikut berani bermimpi lebih besar.",
      position : "text-align: center;",
    },
    {
      id : "introvert",
      header : "Extrovert",
      desc : "Kamu termasuk ekstrovert karena interaksi sosial memberimu energi dan inspirasi baru. Bukan cuma soal senang bertemu banyak orang—kamu menikmati percakapan yang jujur, spontan, dan penuh ide. Lingkungan eksternal memicu kreativitasmu, dan kamu semakin hidup ketika bisa berbagi pemikiran serta mendengar cerita orang lain. Kamu tumbuh lewat koneksi yang autentik",
      position : "text-align: right;",
    },
    {
      id : "intuitive",
      header : "Intuition",
      desc : "Kamu melihat dunia lewat kemungkinan, imajinasi, dan pola besar, bukan hal-hal detail yang konkret. Kamu lebih fokus pada “apa yang bisa terjadi” dibanding “apa yang ada saat ini.” Kamu cepat menemukan peluang baru, memikirkan berbagai alternatif, dan membayangkan skenario kreatif yang belum terpikirkan orang lain. Kamu suka ide-ide abstrak, topik filosofis, dan konsep yang membuka cara pandang baru.",
      positions : "text-align: left;",
    },
    {
      id : "thinking",
      header : "Feeling",
      desc : "Kamu membuat keputusan berdasarkan nilai personal, perasaan, dan hubungan manusiawi. Kamu ingin keputusanmu tetap mencerminkan siapa dirimu, sekaligus menghargai perasaan orang lain. Kamu peduli tentang menjadi autentik dan menjaga keharmonisan dalam hubungan. Kamu cenderung bertanya, “Apa ini sesuai dengan apa yang aku yakini?” sebelum mempertimbangkan sisi teknis atau logisnya.",
      position : "text-align: center;",
    },
    {
      id : "judging",
      header : "Perceiving",
      desc : "Kamu lebih suka kebebasan, fleksibilitas, dan ruang untuk improvisasi daripada struktur yang kaku. Kamu berkembang ketika kamu bisa mengikuti alur ide, bukan terjebak dalam rencana yang terlalu ketat. Kamu suka eksplorasi, spontanitas, dan membiarkan hal-hal berkembang secara alami. Kamu merasa hidup ketika kamu punya pilihan terbuka dan bisa bergerak sesuai intuisi serta suasana hati kreativitasmu.",
      position : "text-align: right;",
    },
  ...
  const songs = [
  { 
    img: './image/enfp-folder/music1.jpg', 
    title: "Edamame", 
    artist: "Bbno$" 
  },
  { img: './image/enfp-folder/music2.jpg',
    title: "Cupid", 
    artist: "FIFTY FIFTY" 
  },
  { img: './image/enfp-folder/music3.jpg',
    title: "Magnetic", 
    artist: "ILLIT" 
  },
  { img: './image/enfp-folder/music4.jpg', 
    title: "Dandelions", 
    artist: "Ruth B." 
  }
  ]
  const characters = [
  {
    ...
    img: './image/enfp-folder/char1.jpg'
  },
  {
    name: 'Rapunzel',
    quote: 'I’ve got a dream!',
    img: './image/enfp-folder/char2.jpg'
  },
  {
    name: 'Walt Disney',
    quote: 'When you’re curious, you find lots of interesting things to do',
    img: './image/enfp-folder/char3.jpg'
  },
  {
    name: 'Robin Williams',
    quote: 'No matter what people tell you, words and ideas can change the world.',
    img: './image/enfp-folder/char4.jpg'
  }
];
const career = [
    {
      name: "Desainer Kreatif",
      desc: "Kreasi bebas ENFP menghasilkan desain penuh warna yang mencerminkan ekspresi personal melalui imajinasi dinamis mendalam.",
      img: "./image/enfp-folder/career1.jpg",
    },
    {
      name: "Penulis Naskah",
      desc: "Intuisi imajinatif ENFP menghidupkan cerita kuat melalui karakter ekspresif yang berkembang dinamis sepanjang alur dramatik",
      img: "./image/enfp-folder/career2.jpg",
    },
    {
      name: "Marketing",
      desc: "Karisma komunikatif ENFP mendukung strategi pemasaran kreatif melalui pesan persuasif yang menarik perhatian banyak audiens",
      img: "./image/enfp-folder/career3.jpg",
    },
  ];
const subjects = [
    {
      name: "Bahasa Indonesia",
      desc: "Kreativitas spontan ENFP memudahkan eksplorasi ide bebas melalui penggunaan bahasa ekspresif yang dinamis mendalam sekali",
      img: "./image/enfp-folder/mapel1.jpg",
    },
    {
      name: "Seni Budaya",
      desc: "Energi imajinatif ENFP mendukung penciptaan karya kreatif yang mengekspresikan nilai budaya melalui estetika personal mendalam.",
      img: "./image/enfp-folder/mapel2.jpg",
    },
    {
      name: "Sosiologi",
      desc: "Rasa ingin tahu ENFP memudahkan pemahaman interaksi sosial melalui pengamatan spontan yang intuitif kreatif luas.",
      img: "./image/enfp-folder/mapel3.jpg",
    },
  ];
let open = false;
</script>
...
<footer class="text-center mt-8 md:mt-12 text-xs md:text-sm text-gray-500 px-4">
    <hr class="my-4" />
    <p>"Kehidupan adalah petualangan yang penuh kemungkinan. Setiap hari adalah kesempatan untuk mengalami sesuatu yang baru dan menginspirasi."</p>
